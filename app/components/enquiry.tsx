...
const Enquiry = () => {
  ...
  // Type the event in handleChange
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    const { name, value } = e.target;
    setFormData({ ...formData, [name]: value });
  };

  // Type the event in handleSubmit
  ...
  return (
    <section className="flex flex-col lg:flex-row bg-cover bg-center py-12 pt-36">
      {/* Left Side */}
      <div className="lg:w-1/2 bg-opacity-80 text-black p-10 flex flex-col justify-center">
        <Image
          src="/nav-logo.png"
          alt="Logo"
          width={200} // Add a specific width for optimization
          height={100} // Add a specific height for optimization
          className="mb-6"
        />
        <h2 className="text-3xl font-semibold mb-6">Enquire Today for More Information</h2>
      ...
      <div className="lg:w-1/2 p-10 rounded-lg">
        {formSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-black font-medium mb-2">Reason for enquiry*</label>
              <select
                name="reason"
              ...
              >
                ...
                <option value="Eligibility Confirmation">Eligibility Confirmation</option>
